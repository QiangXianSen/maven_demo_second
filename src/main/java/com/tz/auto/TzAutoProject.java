...
public class TzAutoProject {
	...
	//注释
	private static String description = "日记管理";
	private static String author = "柯柯";
	...
	//目录结构
	private static String srcPath = "src/main";
	private static String beanPath = "java/com/tz/bean/";
	private static String daoPath = "java/com/tz/dao/";
	private static String servicePath = "java/com/tz/service/";
	private static String serviceImplPath = "java/com/tz/service/"+smallBeanName+"/impl/";
	private static String webPath = "java/com/tz/web/"+smallBeanName+"/";
	private static String pagePath = srcPath+"/webapp/WEB-INF/pages/"+smallBeanName+"/";
